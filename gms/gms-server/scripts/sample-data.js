...
// Connect to MongoDB
const connectionString = 'mongodb+srv://gms_user:s3cret@bellevueuniversity.qvr6m2e.mongodb.net/?appName=BellevueUniversity';
...
const sampleGardens = [
    {
        ...
        description: 'A beautiful garden with arious types of roses.'
    },
    {
...
async function createSampleData() {
    try {
        ...
        const updatedSamplePLants = samplePlants.map(plant => ({
            ...plant,
            gardenId: gardenOdMap[plant.gardenName]
        }));

        console.log('Updated sammple plants:', updatedSamplePlants);
