...
app.use((req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Methods', 'GET, POST, PUT, PATCH, DELETE, OPTIONS'); // Allowed request methods *Added PATCH
